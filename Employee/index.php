...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT EmployeeId, username, password FROM Employees WHERE username = ?";
...
<head>
    ...
    <title>Intraconnexxt Employee | Login</title>
    ...
    <div class="container">
        ...
        <form class="form-login" action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          <h2 class="form-login-heading">Employee Login</h2>  
			...
			<a href="../admin/index.php" class="btn btn-theme btn-block" value =""  >Login as Admin</a>
			</div>
