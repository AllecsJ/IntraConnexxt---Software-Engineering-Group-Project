...
if(isset($_POST['Submit']))
{
	...
	mysqli_query($con,"update Employees set FirstName='$fname' ,LastName='$lname' , EmployeeType='$contact' where EmployeeId='".$_GET['uid']."'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from Employee where EmployeeId='".$_GET['uid']."'");
